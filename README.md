...
Then the `Row` widget is wrapped with the `Column` widget together with the due date display into a column. 
...
### `dialog_box.dart`
This class is will show a dialog box used to enter new tasks. 
